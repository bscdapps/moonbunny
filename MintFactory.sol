...
contract MintFactory is ERC721, Ownable, ReentrancyGuard {
    ...
    uint public _reservedTokens = 33;
    uint256 _mintPrice = 100000000000000000;
    ...
    constructor() ERC721("Moon Bunny", "BUNNY") {
        setBaseURI("ipfs/QmaAFseseA7WniXVg2ESetSehmrxevomUVJKt4HyX6pXnk");
        _owner = msg.sender;
